  ...
  <header>
    <nav>
      <v-app-bar flat app>
        ...
        <ul>
          <li><a class="active" href="#LoginWeb">Inicio</a></li>
          <li><a href="#Precios">Servicios</a></li>
    ...
    <label for ="check" class="checkbtn">
        ...
        >
          ...
          <span style="color: white"> Unirme</span>
        </v-btn>
      </v-app-bar>
    </nav>
  </header>
